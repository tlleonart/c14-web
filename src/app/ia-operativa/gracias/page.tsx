...
export const metadata: Metadata = {
  ...
  description: 'Tu solicitud de validación fue recibida. Nos ponemos en contacto en menos de 48 horas.',
  robots: { index: false, follow: false },
}

export default function IaOperativaGraciasPage() {
  return (
    <>
      <MinimalHeader />
      ...
      <section className={styles.section}>
        <div className={styles.card}>
          ...
          <p className={styles.body}>
            Recibimos tu solicitud. En menos de 48 horas hábiles te vamos a contactar con un
            diagnóstico técnico inicial sobre si tu proceso es automatizable con IA operativa.
          </p>
